...
module.exports = function(router) {
    router.get('/audit/create-report-date', function(req, res, next) {
        authorisation.hasRoles(req, [applicationRoles.BAND_9, applicationRoles.CASEWORK_MANAGER_BAND_5])
         ...
         getAuditConfig().then(function(result) {
            ...
            addAuditSessionData(req, 'thresholdAmount', thresholdAmount)
            res.render('audit/create-report-date', { thresholdAmount })
         })
    ...
    router.post('/audit/create-report-date', function(req, res, next) {
        ...
        addAuditSessionData(req, 'startDate', auditReportStartDate)
        addAuditSessionData(req, 'endDate', auditReportEndDate)
        ...
        getClaimCount(auditReportStartDate, auditReportEndDate).then(function(result) {
            ...
            addAuditSessionData(req, 'claimCount', result[0].Count)
            addAuditSessionData(req, 'claimCountOver250', result1[0].Count)
