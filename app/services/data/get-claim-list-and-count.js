  ...
  return knex('Claim')
    ...
    .then(function (count) {
      return knex('Claim')
        ...
        .join('Visitor', 'Eligibility.EligibilityId', '=', 'Visitor.EligibilityId')
        .where({'Claim.Status': status, 'Claim.IsAdvanceClaim': advanceClaims})
        .select('Eligibility.Reference', 'Visitor.FirstName', 'Visitor.LastName', 'Claim.DateSubmitted', 'Claim.DateOfJourney', 'Claim.ClaimType', 'Claim.ClaimId', 'Claim.AssignedTo', 'Claim.AssignmentTime')
