  ...
  return knex('Claim')
    ...
    .then(function (claim) {
      return knex('Claim')
        ...
        .where('Claim.ClaimId', claimId)
        .select('ClaimExpense.ExpenseType', 'ClaimExpense.Cost', 'ClaimExpense.ApprovedCost', 'ClaimExpense.To', 'ClaimExpense.From', 'ClaimExpense.IsReturn', 'ClaimExpense.TravelTime',
