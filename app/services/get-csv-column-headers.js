...
module.exports = function (claims) {
  ...
  var columns = ['Name', 'Prison Name', 'Prisoner Relationship', 'Child Count', 'Has Escort?', 'Visit Date', 'Claim Submission Date', 'Region', 'Benefit Claimed', 'Assisted Digital Caseworker', 'Caseworker', 'Trusted?', 'Status', 'Date Reviewed by Caseworker', 'Is Advance Claim?', 'Total amount paid', 'Payment Method', 'Rejection Reason']
  var i
