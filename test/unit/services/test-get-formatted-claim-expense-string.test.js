...
describe('services/get-formatted-claim-expense-string', () => {
  it('should return a correctly formatted string for a single expense', () => {
  ...
  it('should return a correctly formatted string for multiple expenses', () => {
  ...
  it('should return 0 for claims that dont have an ApprovedCost', () => {
