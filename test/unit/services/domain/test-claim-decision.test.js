...
describe('services/domain/claim-decision', () => {
  ...
  const VALID_CLAIMEXPENSES_REJECTED = [
    { claimExpenseId: '1', approvedCost: '20.00', cost: '20.00', status: 'REJECTED' },
  ]
  ...
  it('should construct a domain object given valid input', () => {
    claimDecision = new ClaimDecision(
      VALID_CASEWORKER,
      VALID_ASSISTED_DIGITAL_CASEWORKER,
      VALID_DECISION_REJECTED,
      '',
      '',
      VALID_NOTE_REJECTION,
      VALID_NOMIS_CHECK,
      VALID_DWP_CHECK,
      VALID_VISIT_CONFIRMATION_CHECK,
      VALID_CLAIMEXPENSES,
      VALID_CLAIMDEDUCTION,
      NOT_ADVANCE_CLAIM,
      null,
      null,
      futureDay,
  ...
  it('should construct a domain object given valid input but no visit confirmation as advance claim', () => {
    claimDecision = new ClaimDecision(
      VALID_CASEWORKER,
      VALID_ASSISTED_DIGITAL_CASEWORKER,
      VALID_DECISION_REJECTED,
  ...
  it('should return isRequired error for decision given empty strings', () => {
    try {
      claimDecision = new ClaimDecision(
        VALID_CASEWORKER,
        VALID_ASSISTED_DIGITAL_CASEWORKER,
  ...
  it('should return isRequired error for note given on reject', () => {
    try {
      claimDecision = new ClaimDecision(
        VALID_CASEWORKER,
        '',
  ...
  it('should return isRequired error for note given on request information', () => {
    try {
      claimDecision = new ClaimDecision(
        VALID_CASEWORKER,
        '',
        VALID_DECISION_REQUESTED,
        '',
        '',
        '',
        VALID_NOMIS_CHECK,
  ...
  it('should return isRequired error for nomis-check given empty strings', () => {
    try {
      claimDecision = new ClaimDecision(
        VALID_CASEWORKER,
        '',
  ...
  it('should return isRequired error for dwp-check given empty strings', () => {
    try {
      claimDecision = new ClaimDecision(
        VALID_CASEWORKER,
        '',
  ...
  it('should return isRequired error for visit-confirmation-check given empty strings', () => {
    try {
      claimDecision = new ClaimDecision(
        VALID_CASEWORKER,
        '',
  ...
  it('should return error for invalid claim expenses', () => {
    try {
      claimDecision = new ClaimDecision(
        VALID_CASEWORKER,
        '',
  ...
  it('should return error if approving with all expenses rejected', () => {
    try {
      claimDecision = new ClaimDecision(
        VALID_CASEWORKER,
        '',
        VALID_DECISION_APPROVED,
        '',
        '',
        '',
        '',
      ...
      expect(e).toBeInstanceOf(ValidationError)
      expect(e.validationErrors['claim-expenses'][0]).toBe(
        'At least one expense must not be rejected for the claim to be approved',
      )
    }
  })

  it('should return error if same caseworker as assisted digital caseworker', () => {
    try {
      claimDecision = new ClaimDecision(
        VALID_CASEWORKER,
        VALID_CASEWORKER,
  ...
  it('should return error if the "Other" Reason is chosen and a manual rejection reason is not entered', () => {
    try {
      claimDecision = new ClaimDecision(
        VALID_CASEWORKER,
        '',
  ...
  it('should return an error if the benefit expiry date boxes are blank', () => {
    try {
      claimDecision = new ClaimDecision(
        VALID_CASEWORKER,
        '',
  ...
  it('should return error if the Release Date checkbox is checked and the release date boxes are blank', () => {
    try {
      claimDecision = new ClaimDecision(
        VALID_CASEWORKER,
        '',
  ...
  it('should return error if the Release Date checkbox is checked and the release date boxes contain a past date', () => {
    try {
      claimDecision = new ClaimDecision(
        VALID_CASEWORKER,
        '',
