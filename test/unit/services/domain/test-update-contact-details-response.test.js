...
describe('services/domain/update-contact-details-response', () => {
  ...
  it('should throw validation error if email address is invalid', () => {
    try {
  ...
  it('should throw validation error if email address is empty', () => {
    try {
