...
describe('services/domain/claim-decision', function () {
  ...
  it('should construct a domain object given valid input', function (done) {
    claimDecision = new ClaimDecision(VALID_DECISION, '', VALID_REASON, '', '', NOTE, VALID_NOMIS_CHECK, VALID_DWP_CHECK, VALID_CLAIMEXPENSES)
  ...
  it('should return isRequired error for decision given empty strings', function (done) {
    try {
      claimDecision = new ClaimDecision('', '', '', '', '', '', VALID_NOMIS_CHECK, VALID_DWP_CHECK, VALID_CLAIMEXPENSES)
    } catch (e) {
  ...
  it('should return error for invalid claim expenses', function (done) {
    try {
      claimDecision = new ClaimDecision('', '', '', '', '', '', '', '', INVALID_CLAIMEXPENSES)
    } catch (e) {
      expect(e).to.be.instanceof(ValidationError)
