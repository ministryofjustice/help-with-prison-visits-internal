...
jest.mock('../../../../app/services/data/dashboard/get-auto-approved-claim-count', () => mockGetAutoApprovedClaimCount)

jest.mock('../../../../app/services/data/dashboard/get-in-progress-claim-count', () => mockGetInProgressClaimCount)
...
jest.mock('../../../../app/services/data/dashboard/get-paid-claim-count', () => mockGetPaidClaimCount)

jest.mock('../../../../app/services/data/dashboard/get-pending-claim-count', () => mockGetPendingClaimCount)

jest.mock('../../../../app/services/data/dashboard/get-rejected-claim-count', () => mockGetRejectedClaimCount)

const getDashboardData = require('../../../../app/services/data/dashboard/get-dashboard-data')

describe('services/data/dashboard/get-dashboard-data', () => {
  it('should call all of the relevant functions', () => {
    const testFilter = 'test filter'
    return getDashboardData(testFilter).then(result => {
  ...
  it('should return a valid object', () => {
    const testFilter = 'test filter'
    return getDashboardData(testFilter).then(dashboardData => {
