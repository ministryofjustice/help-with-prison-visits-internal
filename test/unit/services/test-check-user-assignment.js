...
describe('services/check-user-assignment', function () {
  it('should return true if user is assigned and not expired', function () {
    ...
    expect(checkUserAssignment(user, assignedTo, assignmentExpiry)).toBe(true) //eslint-disable-line
  })
  ...
  it('should return false if user is not assigned', function () {
    ...
    expect(checkUserAssignment(user, assignedTo, assignmentExpiry)).toBe(false) //eslint-disable-line
  })
