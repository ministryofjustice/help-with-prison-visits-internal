...
describe('routes/helpers/merge-claim-expenses-with-submitted-responses', () => {
  beforeAll(() => {
    oldData = [
      {
        ClaimExpenseId: 1,
  ...
  it('should return an array of claim expenses', () => {
  ...
  it('should set the status of each element in array', () => {
    const mergedData = mergeClaimExpensesWithSubmittedResponses(oldData, newData)
  ...
  it('should set the approvedCost of each element in array', () => {
    const mergedData = mergeClaimExpensesWithSubmittedResponses(oldData, newData)
  ...
  it('should set Error in only those who have incorrect data', () => {
    const mergedData = mergeClaimExpensesWithSubmittedResponses(oldData, newData)
  ...
  it('should return the old data if no new data exists', () => {
