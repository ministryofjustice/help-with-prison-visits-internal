...
describe('routes/audit/create-report', () => {
  let app
  ...
  describe('GET /audit/create-report', () => {
  ...
  describe('POST /audit/create-report', () => {
    it('should respond with a 200 when reportId already exist in session', () => {
    ...
    it('should respond with a 200 when reportId not exist in session', () => {
      return supertest(app)
        .post('/audit/create-report')
        .expect(200)
        .expect(() => {
