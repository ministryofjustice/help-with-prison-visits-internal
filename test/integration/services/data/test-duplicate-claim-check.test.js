...
describe('services/data/duplicate-claim-check', () => {
  describe('module', () => {
    ...
    it('returns true if another claim exists with the same NI number, prisoner number and date of visit', () => {
    ...
    it('returns false if no other claim exists with the same NI number, prisoner number and date of visit', () => {
