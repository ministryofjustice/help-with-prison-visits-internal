...
describe('services/data/get-claim-list-for-search', () => {
  beforeAll(() => {
  ...
  it('should return inserted claim when a full reference number is provided', () => {
  ...
  it('should return inserted claims when a partial reference number is provided', () => {
    return getClaimsListForSearch('SEARCH', 0, 10)
      .then(result => {
        const claimsWithMatchingReference = result.claims.filter(claim => {
          return claim.Reference === reference1 || claim.Reference === reference2
        })
        expect(claimsWithMatchingReference.length).toBe(2)
        const claimsWithCurrentId = result.claims.filter(claim => {
  ...
  it('should not return claims with a reference number that does not match', () => {
    return getClaimsListForSearch('SEARCH', 0, 10)
      .then(result => {
  ...
  it('should return inserted claim when a full NI number is provided', () => {
  ...
  it('should return inserted claim when a partial NI number is provided', () => {
  ...
  it('should not return claims with a NI number that does not match', () => {
    return getClaimsListForSearch(testData.Visitor.NationalInsuranceNumber, 0, 10)
      .then(result => {
        const claimsWithReference3 = getClaimReference(result, reference3)
        expect(claimsWithReference3.length).toBe(0)
  ...
  it('should return inserted claim when a full Prison Number is provided', () => {
  ...
  it('should return inserted claim when a partial Prison Number is provided', () => {
  ...
  it('should not return claims with a Prison number that does not match', () => {
  ...
  it('should return inserted claim when a full name is provided', () => {
  ...
  it('should return inserted claim when a first name is provided', () => {
  ...
  it('should return inserted claim when a last name is provided', () => {
  ...
  it('should not return claims with a name that does not match', () => {
    return getClaimsListForSearch(testFirstName, 0, 10)
      .then(result => {
        const claimsWithReference3 = getClaimReference(result, reference3)
        expect(claimsWithReference3.length).toBe(0)
  ...
  it('should return no claims when none match search criteria', () => {
