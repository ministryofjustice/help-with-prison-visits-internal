...
// describe('services/data/submit-claim-response', () => {
//   beforeAll(() => {
...
//   it('should update remaining overpayment amounts if claim is approved', () => {
...
//   it('should update eligibility and claim then call to send notification', () => {
//     const claimId = newIds.claimId
//     const claimResponse = {
//       caseworker,
...
//   it('should add a DateApproved if claim is approved', () => {
//     const claimId = newIds.claimId
//     const claimResponse = {
//       caseworker,
//       decision: claimDecisionEnum.APPROVED,
...
//   it('should set DateApproved to null if claim is rejected', () => {
//     const claimId = newIds.claimId
//     const claimResponse = {
//       caseworker,
//       decision: claimDecisionEnum.REJECTED,
...
//   it('should set DateApproved to null if caseworker requests more information', () => {
//     const claimId = newIds.claimId
//     const claimResponse = {
//       caseworker,
...
//   it('should set payment method to manually processed if all claim expenses have been manually processed', () => {
//     const claimId = newIds.claimId
//     const claimResponse = {
//       caseworker,
//       decision: claimDecisionEnum.APPROVED,
