...
describe('services/data/audit/get-all-claims-data-below-threshold', () => {
  describe('module', () => {
    beforeAll(() => {
      const promises = []
    ...
    it('should return the correct data between today and 5 months ago for given threshold and percent', () => {
    ...
    it('should return the correct number of claim between today and 2 months ago for given threshold and percent', () => {
