...
describe('services/data/audit/get-claim-count', function () {
  describe('module', function () {
    ...
    it('should return the correct data between today and 5 months ago for given threshold and percent', function () {
      ...
      const expectedResult = [{ Reference: 'TEST', ClaimId: 1231, PaymentAmount: 49 }, { Reference: 'TEST', ClaimId: 1233, PaymentAmount: 25 }, { Reference: 'TEST', ClaimId: 1235, PaymentAmount: 65 }]
    ...
    it('should return the correct number of claim between today and 2 months ago for given threshold and percent', function () {
      const expectedResult = [{ Reference: 'TEST', ClaimId: 1231, PaymentAmount: 49 }, { Reference: 'TEST', ClaimId: 1232, PaymentAmount: 100 }, { Reference: 'TEST', ClaimId: 1233, PaymentAmount: 25 }]
