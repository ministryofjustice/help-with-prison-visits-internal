...
describe('services/data/insert-task-send-first-time-claim-notification', () => {
  beforeAll(() => {
  ...
  it('should insert a new task to send the first time claim notification', () => {
  ...
  it('should insert a new task to send a notification to a specific email address', () => {
