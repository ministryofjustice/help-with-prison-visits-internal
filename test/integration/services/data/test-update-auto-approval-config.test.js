...
describe('services/data/update-auto-approval-config', () => {
  ...
  it('should disable the current Auto Approval config and insert the new one', () => {
  ...
  it('should disable the current Auto Approval config and insert the new one if rulesDisabled is null', () => {
    const AutoApprovalConfig = {
      caseworker: 'second-caseworker',
