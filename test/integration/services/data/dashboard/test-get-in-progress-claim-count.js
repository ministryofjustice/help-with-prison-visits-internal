...
describe('services/data/dashboard/get-in-progress-claim-count', function () {
  describe('module', function () {
    before(function () {
      return databaseHelper.insertTestData(reference, date, claimStatusEnum.NEW.value)
        .then(function (ids) {
    ...
    it('should return the correct total number of In Progress claims in the system', function () {
