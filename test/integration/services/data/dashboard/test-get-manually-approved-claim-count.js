...
describe('services/data/dashboard/get-manually-approved-claim-count', function () {
  describe('module', function () {
    before(function () {
      return databaseHelper.insertTestData(reference, date, claimStatusEnum.APPROVED.value)
        .then(function (ids) {
          ...
          promises.push(databaseHelper.insertClaim(claimId2, eligibilityId, reference, yesterday, claimStatusEnum.APPROVED.value, false))
          promises.push(databaseHelper.insertClaim(claimId3, eligibilityId, reference, lastWeek, claimStatusEnum.APPROVED.value, false))
          promises.push(databaseHelper.insertClaim(claimId4, eligibilityId, reference, oneMonthAgo, claimStatusEnum.APPROVED.value, false))
          promises.push(databaseHelper.insertClaim(claimId5, eligibilityId, reference, twoMonthsAgo, claimStatusEnum.APPROVED.value, false))
          promises.push(databaseHelper.insertClaim(claimId6, eligibilityId, reference, threeMonthsAgo, claimStatusEnum.APPROVED.value, false))
          promises.push(databaseHelper.insertClaim(claimId7, eligibilityId, reference, fourMonthsAgo, claimStatusEnum.APPROVED.value, false))
          promises.push(databaseHelper.insertClaim(claimId8, eligibilityId, reference, yesterday, claimStatusEnum.AUTOAPPROVED.value, false))
    ...
    it('should return the correct total number of manually Approved claims in the system', function () {
