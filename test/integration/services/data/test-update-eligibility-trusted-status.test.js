...
// describe('services/data/update-eligibility-trusted-status', () => {
//   beforeEach(() => {
//     sandbox.reset()
//   })
...
//   it('should set the eligibility to untrusted and create a claim event', () => {
...
//   it('should set the eligibility to trusted and create a claim event', () => {
...
//   it('should do nothing if current and new IsTrusted values are the same', () => {
