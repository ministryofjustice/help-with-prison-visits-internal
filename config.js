module.exports = {
  ...
  NEW_HOST: process.env.MANAGE_USERS_API_URL,
  ...
  NEW_USER_PATH_PREFIX: process.env.MANAGE_USERS_API_PATH_PREFIX,
  NEW_USER_DETAILS_PATH: process.env.MANAGE_USERS_API_USER_DETAILS_PATH,
